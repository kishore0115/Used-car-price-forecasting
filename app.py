...
data = load_data('https://raw.githubusercontent.com/kishore0115/Used-car-price-forecasting/main/Dataset/dataset_temp.csv') 

# data_for_range = pd.read_csv('./Dataset/final_data.csv')

data_for_range = load_data('https://raw.githubusercontent.com/kishore0115/Used-car-price-forecasting/main/Dataset/final_data.csv') 
# st.dataframe(data) 
...
def analyzer_brand(brand):
    ...
    df = load_data('https://raw.githubusercontent.com/kishore0115/Used-car-price-forecasting/main/Dataset/train-new-car-dataset.csv')
...
def main():
    st.title("Machine Learning Strategies for Optimal Usage of used Car Price Forecasting") 
    st.sidebar.title("Cars.com")
    st.sidebar.subheader("Used Car Price Prediction")
    st.sidebar.image('https://thinkingneuron.com/wp-content/uploads/2020/09/Car-price-prediction-case-study.png')
